...
<form action="${pageContext.request.contextPath}/sanphamsapdau">
	<div class="Column3">
				...
				<c:when test="${sessionScope.dsloaisp != null}">
						...
						<c:choose>
							<c:when test="${lsp.maloaisp == maLoaiSP}">
								<li class="CategoryList" style="background-color: gainsboro;"><a
									href="${pageContext.request.contextPath}/sanphamsapdau?maLoaiSP=${lsp.maloaisp}&trang=${trang}&soLuongSanPhamTrenTrang=${soLuongSanPhamTrenTrang}">+&nbsp;${lsp.tenloaisp}</a>
								</li>
							</c:when>
							<c:otherwise>
					...
					<c:choose>
							<c:when test="${-1 == maLoaiSP}">
								<li class="CategoryList" style="background-color: gainsboro;"><a
						href="${pageContext.request.contextPath}/sanphamsapdau?maLoaiSP=-1&trang=${trang}&soLuongSanPhamTrenTrang=${soLuongSanPhamTrenTrang}">+&nbsp;Tất
							cả</a></li>
							</c:when>
							<c:otherwise>
								<li class="CategoryList"><a
			...
			<table width="100%">
				<tr>
					<td width="70%" align="center"><label style="">Trang
							...
							<a style="color:#00C"
								href="${pageContext.request.contextPath}/sanphamsapdau?maLoaiSP=${maLoaiSP}&trang=${i}&soLuongSanPhamTrenTrang=${soLuongSanPhamTrenTrang}">
