		...
		function vartimerdsdgtick() {
			$
					.ajax({
						...
						type : "POST",
						url : "/AuctionWebApp/loaddsdatgia",
						data : "masp=" + masp,
						success : function(data) {
							// we have the response
							//$('#error').html(data);
						...
						function vartimertick() {
							...
							if (Math.floor(timeLeft) > 0) {
								...
								$
										.ajax({
											type : "POST",
											url : "/AuctionWebApp/kiemtranguoidatgia",
