...
<form action="${pageContext.request.contextPath}/sanphamdadau">
	<div class="Column3">
			...
			<table width="100%">
				<tr>
					<td width="70%" align="center"><label style="">Trang
							...
							<a style="color:#00C"
								href="${pageContext.request.contextPath}/sanphamdadau?maLoaiSP=${maLoaiSP}&trang=${i}&soLuongSanPhamTrenTrang=${soLuongSanPhamTrenTrang}">
